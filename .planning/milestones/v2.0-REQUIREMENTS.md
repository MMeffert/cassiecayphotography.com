# Requirements Archive: v2.0 jQuery Removal & Bootstrap 5 Migration
...
**Shipped:** 24 of 24 v2.0 requirements (100%)

**Adjusted during implementation:**
- PORT-01: Changed from "CSS Grid + vanilla JS" to "Muuri + vanilla JS" after research showed CSS masonry not production-ready
- UTIL-02 and UTIL-03: Completed in Phase 12 instead of Phase 13 (natural fit with navigation work)

**Dropped:** None

**Deferred to v2.1+:**
- WORK-01: Folder-based image galleries (deferred from v1, still pending)
